...
<div id="screen4" class="mx-auto max-w-[26rem] p-10 bg-white shadow-md  h-auto" style="margin-top:200px;">
    ...
    <div class="flex justify-center mb-4">
      <img src="{{asset('asset/images/Yuwaahlogo.png')}}" alt="YuWaah Logo" class="w-[100px] h-[86px]">
    </div>
    <h1 class="w-[382px] h-[34px] font-[600] text-[28px] leading-[34.13px] text-[#000000]  mb-4">Placement Partner Login</h1>



    <form method="POST" action="{{ route('pppartner.login') }}" class="space-y-4 text-xs">
    @csrf
      <div class="space-y-1">
        <label for="username" class="w-[63px] h-[15px] font-[400] text-[12px] leading-[14.63px] text-[#000000]">Email Address</label>
