...
@section('title', $agentArray['name'].' ['.$agentArray['sakhi_id'].']')
@section('content')
...
<div class="container">
       <table class="table w-100">
            <tr>
                ...
                <a href="{{ route('placementpartner.learners.export', array_merge(request()->all(), ['agent_id' => encryptString($agentArray->id)])) }}">
                        <b>
