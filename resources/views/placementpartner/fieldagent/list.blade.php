...
@section('title', 'Field Agent With Event Transctions')
@section('content')
...
<table class="table table-striped table-bordered">
            <tr>
                ...
                <a href="{{route('placementpartner.filed-agents.export')}}"><b><img src="{{asset('asset/images/export.jpg')}}" width="25px" height="25px">&nbsp;Export Field Agent</b></a></td>
            </tr>
            <tr>
        ...
        <?php $count=1;  //dd($data);?>
            ...
            <tr>
                ...
                <td>@if($item->learner_count>0)
                    <a href="{{route('placementpartner.viewfieldagent',['id'=>encryptString($item->id)])}}" class="text-primary fw-bold">View</a>
                    @else
                    View
                    @endif
                </td>
