      <div id="toggleSortPopUp()" class="mt-6 hidden fixed inset-0 flex items-center justify-center z-50">
        <div class="bg-white  w-[310px] h-[400px] absolute top-[130px] border-[1px]"
          ...
          <form class="space-y-[2px]" action="" method="post">
            ...
            <div class="">
              <label
                class="w-[38px] h-[12px] font-[400] text-[10px] leading-[12.19px] text-center text-[#000000]">Event Name</label>
            ...
            <div>
              ...
              <label
                class="w-[20px] h-[12px] font-[400] text-[10px] leading-[12.19px] text-center text-[#000000]">Beneficiary Name</label>
            ...
            <div>
              ...
              <label
                class="w-[20px] h-[12px] font-[400] text-[10px] leading-[12.19px] text-center text-[#000000]">Beneficiary Number</label>
              <div class="flex justify-between gap-2 items-center text-xs">
            ...
            <div class="">
              <label
                class="w-[80px] h-[12px] font-[400] text-[10px] leading-[12.19px] text-center text-[#000000]">Event Type
                Level</label>
