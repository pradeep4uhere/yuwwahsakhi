...
<section class="dashboard">
        ...
        <div class="dash-content" >
            ...
            <tr>
              <td>
                    <input type="text" class="form-control" name="name" placeholder="Please enter Partner Name" value="{{old('name')}}">
                </td> 
                <td>
                    <input type="text" class="form-control" name="partner_id" placeholder="Please enter Partner Id" value="{{old('partner_id')}}">
                </td> 
              </tr>
              <tr>
              ...
              <div class="input-container">
                <input type="text" name="contact_number" placeholder="Please Contact Number" value="{{old('contact_number')}}"  minlength="10" maxlength="10" 
       pattern="\d{10}" 
