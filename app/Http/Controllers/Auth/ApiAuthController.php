        ...
        try {
            ...
            $formattedLearners = $paginator->map(function ($item) {
               return [
                    ...
                    "digital_proficiency" => $item->digital_proficiency,
                    "english_knowledge" => $item->english_knowledge,
                    "interested_in_opportunities" => ($item->interested_in_opportunities==1)?'Yes':'No',
