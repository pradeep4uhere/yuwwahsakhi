    ...
    public function fieldAgentWithEventTransactions(Request $request){
        ...
        ->withCount([
           ...
           // Submitted Job Event Transactions Count
            'eventTransactions as open_job_event__transactions_count' => function ($q) use ($eventFilter) {
            ...
            'eventTransactions as pending_job_event__transactions_count' => function ($q)  use ($eventFilter){
            ...
            'eventTransactions as accepted_job_event__transactions_count' => function ($q)  use ($eventFilter){
